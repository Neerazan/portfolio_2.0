  ...
  return (
    <div className="mx-auto max-w-6xl px-6 bg-transparent text-gray-300 relative">
      <div className="max-w-4xl mx-auto sm:px-6 mb-12 sm:mb-24 z-10">
        <div className="p-6 sm:p-8 md:p-10 bg-[#151520]/80 rounded-2xl shadow-2xl border border-white/5 hover:border-white/10 transition-all duration-300">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {[
                ...
                <div
                  key={index}
                  className="p-3 sm:p-4 bg-[#1a1a2e]/95 rounded-xl border border-white/5 hover:border-cyan-500/30 transition-all duration-300 group flex items-center gap-4 hover:bg-white/10"
                >
