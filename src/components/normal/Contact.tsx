  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="flex flex-col rounded-2xl bg-[#151520]/95 p-8 lg:col-span-2 border border-white/5 hover:border-indigo-500/30 transition-all duration-300 shadow-2xl">
