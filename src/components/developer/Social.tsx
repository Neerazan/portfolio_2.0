...
export function Socials() {
  return (
    <div className="font-mono text-xs sm:text-sm text-gray-400 bg-[#0d1117] p-4 rounded border border-gray-800">
      <span className="text-purple-400">const</span> <span className="text-yellow-200">socials</span> <span className="text-white">=</span> <span className="text-yellow-400">{"{"}</span>
